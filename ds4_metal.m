...
int ds4_metal_set_model_map_range_with_max_tensor(const void *model_map,
    ...
    @autoreleasepool {
        ...
        if (!ds4_metal_map_model_views(model_map, model_size, map_offset, map_size, max_tensor_bytes)) {
            ds4_metal_model_residency_clear();
            return 0;
        }
        fprintf(stderr,
...
int ds4_metal_set_model_map_range(const void *model_map, uint64_t model_size, uint64_t map_offset, uint64_t map_size) {
    return ds4_metal_set_model_map_range_with_max_tensor(model_map, model_size, map_offset, map_size, 0);
}
