...
> [!NOTE]
> This fork integrates upstream `antirez/ds4` with raw `/v1/completions`
> ([#61](https://github.com/antirez/ds4/pull/61)) and three opt-in DeepSeek V4.1 Flash
> optimizations: [Metal slab residency](https://github.com/antirez/ds4/pull/1033),
> [streaming decode queue](https://github.com/antirez/ds4/pull/1034), and
> [parallel Engram reads](https://github.com/antirez/ds4/pull/1035).
> See [fork features and usage](docs/FORK.md) for switches and validation.
